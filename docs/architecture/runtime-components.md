...
| OneCLI broker persistence is not ready | `apps/core/src/infrastructure/onecli/persistence.ts`, `apps/core/src/cli/doctor.ts`, `apps/core/src/infrastructure/postgres/storage-readiness.ts`                                     | `ONECLI_DATABASE_URL`, `schema=onecli`, generated base64-encoded 32-byte `SECRET_ENCRYPTION_KEY`, schema existence, OneCLI gateway reachability. |
