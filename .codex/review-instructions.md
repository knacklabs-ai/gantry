...
4. Keep `.codex/architecture-exceptions.json` empty unless a waiver is both deliberate and narrower than changing the map. File line-budget violations are never waived.
