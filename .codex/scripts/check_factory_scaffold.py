...
required = [
    ...
    root / '.codex' / 'skills' / 'gantry-change-contract' / 'SKILL.md',
    root / '.codex' / 'skills' / 'settings-control-plane' / 'SKILL.md',
    root / '.codex' / 'skills' / 'capability-lifecycle' / 'SKILL.md',
    root / '.codex' / 'skills' / 'scheduler-job-lifecycle' / 'SKILL.md',
    root / '.codex' / 'skills' / 'memory-architecture-contract' / 'SKILL.md',
    root / '.codex' / 'skills' / 'runtime-ops-verification' / 'SKILL.md',
    ...
    root / '.codex' / 'agents' / 'surface-impact-reviewer.toml',
    root / '.codex' / 'agents' / 'memory-lessons-curator.toml',
