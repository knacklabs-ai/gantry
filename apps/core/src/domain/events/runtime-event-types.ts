export const RUNTIME_EVENT_TYPES = {
  ...
  AGENT_SETUP_DRAFT_CREATED: 'agent.setup_draft.created',
  AGENT_SETUP_DRAFT_SAVED: 'agent.setup_draft.saved',
  AGENT_SETUP_DRAFT_DISCARDED: 'agent.setup_draft.discarded',
  AGENT_SETUP_COMPLETED: 'agent.setup.completed',
