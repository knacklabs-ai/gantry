...
const CLASSIFIED_KEYS: Record<string, ClassifiedConfigKey> = {
  ...
  TEAMS_BOT_APP_ID: runtimeSecret('TEAMS_BOT_APP_ID'),
  TEAMS_BOT_APP_PASSWORD: runtimeSecret('TEAMS_BOT_APP_PASSWORD'),
  TEAMS_BOT_TENANT_ID: runtimeSecret('TEAMS_BOT_TENANT_ID'),
